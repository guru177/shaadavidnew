...
export default function AdminTestimonialsPage() {
  ...
  return (
    <div className="w-full space-y-5">
      <AdminPageHeader
        pill="വിദ്യാർത്ഥികൾ പറയുന്നത്"
        title="Testimonials"
        subtitle="Customer quotes shown on the homepage — add, edit, or remove anytime."
        actions={
          <>
            <button
              type="button"
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            {filtered.map((t) => (
              <article
                key={t.id}
                className="group flex flex-col rounded-[24px] border border-[#29425e]/08 bg-white p-5 hover:border-[#29425e]/20 hover:shadow-[0_12px_36px_rgba(12,22,34,0.08)] transition-all"
              >
      ...
      {portalReady &&
        ...
        createPortal(
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-lg max-h-[min(92vh,720px)] bg-white rounded-[24px] border border-[#29425e]/10 shadow-[0_24px_60px_rgba(12,22,34,0.18)] overflow-hidden flex flex-col my-auto">
