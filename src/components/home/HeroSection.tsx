      ...
      <div className="flex flex-col md:flex-row w-full xl:contents order-1 xl:order-none">
        ...
        <div className="w-full md:w-1/2 xl:w-[62%] relative flex flex-col justify-center px-6 sm:px-10 lg:px-12 py-6 md:py-10 xl:py-0 z-20 order-1 md:order-1 xl:order-none">
          ...
          <div className="flex flex-col font-malayalam leading-[1.2] xl:leading-[1.3] tracking-tight xl:mt-[-5%] gap-2 md:gap-4">
            ...
            <span className="text-[#111111] text-[48px] sm:text-[60px] md:text-6xl lg:text-7xl xl:text-[5rem] 2xl:text-[7.5rem] font-extrabold leading-[1.1]">
              ഇംഗ്ലീഷ്
            </span>
            <div className="relative inline-block w-max mb-4 xl:mb-6 mt-1 xl:mt-2">
              <span className="text-transparent bg-clip-text bg-[linear-gradient(110deg,#29425e_0%,#395c80_30%,#0c1622_50%,#395c80_70%,#29425e_100%)] bg-[length:200%_auto] animate-shimmer text-[48px] sm:text-[60px] md:text-6xl lg:text-7xl xl:text-[5rem] 2xl:text-[7.5rem] font-extrabold pb-2 leading-[1.1]">
                കമ്പാനിയൻ
              </span>
