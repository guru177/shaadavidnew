    ...
    <section className="relative w-full pt-[100px] md:pt-[140px] xl:pt-[160px] pb-[80px] px-5 md:px-8 xl:px-12 2xl:px-16 max-w-[1920px] mx-auto overflow-hidden">
      <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        <div className="w-full lg:w-1/2 flex flex-col z-10 relative">
          ...
          <h1 className="text-3xl xs:text-4xl md:text-6xl 2xl:text-5xl font-bold text-[#0c1622] mb-6 leading-[1.6] drop-shadow-sm font-malayalam-display overflow-visible break-words">
            ഇംഗ്ലീഷ് സംസാരിക്കാം <br />
            <span className="text-transparent bg-clip-text bg-[linear-gradient(110deg,#29425e_0%,#395c80_30%,#0c1622_50%,#395c80_70%,#29425e_100%)] bg-[length:200%_auto] animate-shimmer inline">ആത്മവിശ്വാസത്തോടെ</span>
          </h1>
