        ...
        <div className="lg:col-span-4 flex flex-col">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-gray-500 text-[15px] font-malayalam">1,245 റേറ്റിംഗുകളെ അടിസ്ഥാനമാക്കി</span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={row.star} className="flex items-center gap-4 text-[15px] group cursor-pointer">
                <span className="text-[#395c80] group-hover:underline w-14 whitespace-nowrap font-malayalam">{row.star} സ്റ്റാർ</span>
          ...
          <div className="mt-10 pt-8 border-t border-gray-100">
            <h3 className="text-[18px] font-medium text-[#0c1622] mb-2 font-malayalam">ഈ ഉൽപ്പന്നത്തെക്കുറിച്ച് റിവ്യൂ എഴുതുക</h3>
            <p className="text-gray-500 text-[15px] mb-6 font-malayalam">മറ്റ് ഉപഭോക്താക്കളുമായി നിങ്ങളുടെ അഭിപ്രായങ്ങൾ പങ്കിടുക</p>
            <WriteReviewButton />
          </div>
        </div>
