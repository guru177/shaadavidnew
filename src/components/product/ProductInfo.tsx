  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-1 mb-8 border-b border-gray-100 pb-8">
        <span className="text-[#395c80] text-[13px] font-bold tracking-wide uppercase">പ്രത്യേക വില</span>
        <div className="flex items-end gap-3">
          ...
          <span className="text-[15px] font-bold text-[#395c80] mb-[2px]">50% കിഴിവ്</span>
        </div>
      </div>

      {/* Description */}
      <div className="py-6">
        <h2 className="text-lg font-medium text-[#0c1622] mb-4">ഉൽപ്പന്ന വിവരണം</h2>
