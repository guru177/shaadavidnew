...
export default function ProductGallery() {
  ...
  return (
    <div className="lg:sticky top-28 flex flex-col gap-4">
      ...
      <div className="w-full aspect-square border border-gray-100 rounded-3xl flex items-center justify-center relative cursor-crosshair group overflow-hidden">
        {activeTab === "3d" ? (
          ...
          <img
            src={images[(activeTab as number) - 1]}
      ...
      <div className="flex gap-2 md:gap-4 w-full pb-2" style={{ scrollbarWidth: 'none' }}>
        {images.map((img, i) => {
          ...
          return (
            ...
            >
              <img src={img} className="w-full h-full object-contain" alt={`Thumbnail ${tabIndex}`} />
            </div>
          );
        })}
        ...
        >
          <img src={images[0]} className="w-full h-full object-contain opacity-40 grayscale" alt="360 Render" />
